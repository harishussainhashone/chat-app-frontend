...
export default function RightSidebar() {
  ...
  return (
    <aside className="w-full md:w-72 bg-white md:border-l border-t md:border-t-0 border-gray-200 p-4 md:p-6">
      {/* Latest Updates */}
      <div className="mb-8">
        <h3 className="text-sm font-semibold text-gray-900 mb-4">Latest Zendesk Chat updates</h3>
