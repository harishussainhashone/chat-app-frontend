        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-white border border-gray-300 rounded px-4 py-2 pr-10 text-sm text-gray-700 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent cursor-pointer"
            >
      ...
      {showBanner && (
        <div className="bg-green-100 border border-green-200 rounded px-4 py-3 flex items-center justify-between mb-4">
          <p className="text-sm text-green-800">
            Your account is on the Zendesk Agent Workspace. You can see incoming and currently served chats on this page.
          </p>
          <button
